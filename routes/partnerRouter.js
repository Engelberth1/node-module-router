...
.get( (req, res) => {
    res.end(`Will send details of the partners: ${req.params.campsiteId} to you`);
})
...
.put((req, res) => {
    res.write(`Updating the partners: ${req.params.campsiteId}\n`);
    res.end(`Will update the partners: ${req.body.name}
        with description: ${req.body.description}`);
})
.delete((req, res) => {
    res.end(`Deleting partners: ${req.params.campsiteId}`);
});
